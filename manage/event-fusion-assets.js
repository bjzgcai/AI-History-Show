...
//
// You can also use:
//   excludeImages: ['exact/url.png']
//   excludeImagePatterns: ['people/', /portrait|avatar/i]

module.exports = {
  // 1957-perceptron ↔ 1958-rosenblatt-perceptron
  '1957-perceptron': {
    images: [
  ...
  // 2012-alexnet ↔ ai100-2012-alexnet
  '2012-alexnet': {
    images: [
  ...
  // 2014-attention ↔ ai100-2014-neural-machine-translation-attention
  '2014-attention': {
    images: [
  ...
  // 2016-densenet ↔ ai100-2017-densenet
  '2016-densenet': {
    images: [
  ...
  // 2017-transformer ↔ ai100-2017-transformer
  '2017-transformer': {
    images: [
  ...
  // 2020-alphafold ↔ ai100-2020-alphafold2
  '2020-alphafold': {
    images: [
